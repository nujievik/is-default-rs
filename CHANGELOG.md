...
- (Nightly) ByteStr, ByteString implementations with `bstr` feature.
- Empty, Sink implementations.
- `?Sized` for generic implementations Arc, Box, Rc, RefCell, RwLock,
Mutex, rc::Weak, sync::Weak.
